    ...
    return (
        <div className="profile-navbar-div">
            <ul>
                ...
                <li>
                    <NavLink to='/profile/profileInfo' activeClassName="menu-active" className='flex flex-col justify-center items-center gap-2  relative'> <span className='menu-outer-span'> <span className="menu-inner-span"><img src="https://i.ibb.co/g99nZMz/user.png" alt="" /></span></span> <span className='menu-text'>Profile</span></NavLink>
                </li>
                <li>
